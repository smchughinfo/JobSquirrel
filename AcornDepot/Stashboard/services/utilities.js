...
function askClaudeSync(message, workingDir = null) {
    ...
    console.log(`🤖 Asking Claude: "${message}"`);
    ...
    try {
        ...
        //const result = execSync("wsl ls", { encoding: 'utf8', timeout: 600000 }); // 10 minutes
        ...
        console.log(`🤖 Claude responded: ${cleanResult.substring(0, 100)}...`);
        return cleanResult;
    } catch (error) {
